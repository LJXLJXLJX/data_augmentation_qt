...
public:
    ...
    QSpinBox *gaussianFilterKySpinBoxMin;
    ...
    QSpinBox *gaussianFilterKySpinBoxMax;
    ...
    void setupUi(QDialog *commandEditorClass)
    {
        ...
        gaussianFilterKySpinBoxMin = new QSpinBox(pageGaussianFilter);
        gaussianFilterKySpinBoxMin->setObjectName(QString::fromUtf8("gaussianFilterKySpinBoxMin"));
        gaussianFilterKySpinBoxMin->setGeometry(QRect(110, 100, 42, 22));
        gaussianFilterKySpinBoxMin->setMinimum(1);
        ...
        gaussianFilterKySpinBoxMax = new QSpinBox(pageGaussianFilter);
        gaussianFilterKySpinBoxMax->setObjectName(QString::fromUtf8("gaussianFilterKySpinBoxMax"));
        gaussianFilterKySpinBoxMax->setGeometry(QRect(200, 100, 42, 22));
        gaussianFilterKySpinBoxMax->setMinimum(1);
